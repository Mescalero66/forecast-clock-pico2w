...
|  `7`  | ***update_forecast()*** | **_forecastMeta**, <br>**_forecastData**, <br> **_timezoneOffset** | **`600`** seconds (10mins)<br>or on request | **_lastRefresh**, <br>**_updateMetadata**, <br> **_forecastToday**, <br> **_forecastTomorrow**  |
...
|  `10`  | ***synchronise_watches()*** | GPS_obj.has_fix = True | **`1440`** seconds or on request | **_lastRefresh** |